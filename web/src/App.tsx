            ...
            <form className='mt-8 flex flex-col gap-4'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  ...
                  <Input id='yearsPlayning' placeholder='Tudo bem ser ZERO' type='number' />
                </div>
              ...
              <div className='flex gap-6'>
                ...
                <div className='flex flex-col gap-2 flex-1'>
                  <label htmlFor='timeOfDay'>Qual horário do dia?</label>
                  <div className='grid grid-cols-2 gap-2'>
                    <Input id='hoursStart' placeholder='De' type='time' />
                    <Input id='hoursEnd' placeholder='Até' type='time' />
                  </div>
                </div>
              </div>
